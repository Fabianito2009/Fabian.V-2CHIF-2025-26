...
export class Lokomotive extends TrainPart {
    restriction: PartRestriction = PartRestriction.MustBeFirst;
    ...
    render(): HTMLElement {
        const lokomotive = document.createElement('div');
        lokomotive.className = 'part locomotive';

        const title = document.createElement('div');
        title.className = 'part-title';
        title.textContent = 'Lokomotive';
        lokomotive.appendChild(title);

        const detail = document.createElement('div');
        detail.className = 'part-detail';
        detail.textContent = '2400 kW';
        lokomotive.appendChild(detail);
...
export class Train {
    ...
    addTrainpart(Text: string) {
        if (Text === 'locomotive') {
            this.wagon.push(new Lokomotive());
        } else if (Text === 'passenger') {
            this.wagon.push(new Passenger());
        } else if (Text === 'cargo') {
            this.wagon.push(new Cargo());
        } else if (Text === 'dining') {
            this.wagon.push(new Dining());
        } else if (Text === 'caboose') {
            this.wagon.push(new Caboose());
        }
        this.render();
    }
...
export class Passenger extends TrainPart {
    restriction: PartRestriction = PartRestriction.None;
    ...
    render(): HTMLElement {
        ...
        passenger.className = 'part passenger';
        ...
        const detail = document.createElement('div');
        detail.className = 'part-detail';
        detail.textContent = '48 seats';
        passenger.appendChild(detail);
...
export class Cargo extends TrainPart {
    ...
    render(): HTMLElement {
        ...
        cargo.className = 'part cargo';

        const title = document.createElement('div');
        title.className = 'part-title';
        title.textContent = 'cargo ';
        cargo.appendChild(title);

        const detail = document.createElement('div');
        detail.className = 'part-detail';
        detail.textContent = '35 t';
        cargo.appendChild(detail);
...
export class Dining extends TrainPart {
    ...
    get diningWeightTons(): number {
        return 8;
    }

    render(): HTMLElement {
        const cargo = document.createElement('div');
        cargo.className = 'part dining';
...
export class Caboose extends TrainPart {
    restriction: PartRestriction = PartRestriction.MustBeLast;
    ...
    render(): HTMLElement {
        ...
        caboose.className = 'part caboose';

        const title = document.createElement('div');
        title.className = 'part-title';
        title.textContent = 'Caboose';
        caboose.appendChild(title);

        const detail = document.createElement('div');
        detail.className = 'part-detail';
        detail.textContent = '2 crew';
        caboose.appendChild(detail);
