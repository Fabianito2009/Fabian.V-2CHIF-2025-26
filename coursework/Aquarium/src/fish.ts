...
export class Standingfish extends Fish {
  update(): void {}
}
...
export class Circlefish extends Fish {
  ...
  update() {
    ...
    this.x = this.baseX + Math.cos(this.time) * 50;
    this.y = this.baseY + Math.sin(this.time) * 50;
  }
}

export class Squarefish extends Fish {
